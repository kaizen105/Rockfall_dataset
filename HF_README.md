...
> [!WARNING]
> It is a simulated dataset mapping real-world terrain and weather variables to simulated physics sensors. It is *not* a record of real historical rockfalls.

---

## 📊 2. Dataset Structure & Features
- **Total Rows:** ~12,966,700 (Cleaned Training Dataset)
- **Total Locations:** 500
...
The underlying simulation heavily relies on the Infinite Slope Stability model (Skempton and DeLory):
...
- **Stochastic Generation:** The final physics simulation runs unseeded by design. This encourages variations across regenerations, forcing models to learn underlying physical relationships rather than memorizing exact data noise.
...
- **Noamundi-specific field measurements missing:** Geomechanical data relies on typical ranges from literature.
